class Ecommerce {
    ...
    init() {
        this.$body
            ...
            .on('submit', '.bb-product-form-filter', (event) => {
    ...
    handleProductsPagination(event) {
        ...
        this.$body.find('.bb-product-form-filter').find('input[name="page"]').val(page)
        this.filterProducts(this.$body.find('.bb-product-form-filter'), page)
    }
